...
Copy and paste the URL for your personal fork of the repository here: https://github.com/Juno-Explorer1/HCI-Project2
...
origin git@github.com:Juno-Explorer1/HCI-Project2.git (fetch) origin git@github.com:Juno-Explorer1/HCI-Project2.git (push) upstream git@github.com:hci-code-monkeys/project-2.git (fetch) upstream git@github.com:hci-code-monkeys/project-2.git (push)
